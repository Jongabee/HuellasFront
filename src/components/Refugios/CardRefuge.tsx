...
const CardRefuge: React.FC<{ refugio: IRefugios }> = ({ refugio }) => {
  ...
  return (
<div className="bg-transparent rounded-lg shadow-2xl p-4 m-2 md:m-4 max-w-xs mx-auto transform transition-transform duration-200 hover:scale-105">      <div className="h-64 relative overflow-hidden rounded-t-lg">
